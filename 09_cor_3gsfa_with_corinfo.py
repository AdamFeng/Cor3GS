...
# usage: python 09_cor_3gs_fa_with_corinfo.py  cor_info.txt  fastq_file   corrected_fa_file

import os,sys

if len(sys.argv) != 4:
    print 'usage: python 09_cor_3gs_fa_with_corinfo.py  cor_info.txt  fastq_file  corrected_fa_file'
    exit(1)
